                ...
                <div class="row mt-4">
                    <div class="col-12 col-lg-10 offset-lg-1">
                        ...
                        <div class="mt-4">
                            ...
                            $arraytotal = [];
                            $nomor = 0;
                            $sqltblberita = "SELECT * FROM tbl_desain_produk_user INNER JOIN tbl_produk ON tbl_desain_produk_user.id_produk=tbl_produk.id_produk INNER JOIN tbl_user ON tbl_desain_produk_user.id_user=tbl_user.id_user WHERE tbl_user.email='$sess' AND tbl_desain_produk_user.no_invoice='$id'";
                            ...
                            <div>
                                <span class="text-secondary-d1 text-105">Silahkan transfer total bayar ke Bank BCA 8465557377 a/n Rendi Saputro.</span>
                            </div>
                            <div>
                                <a href="riwayatpesanan" class="btn btn-primary btn-bold px-4 float-right mt-3 mt-lg-0">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
