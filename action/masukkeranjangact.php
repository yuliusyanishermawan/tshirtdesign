...
if (strlen($_SESSION['user']) == 0) {
	...
	$sql     = "INSERT INTO tbl_desain_produk_user VALUES ('','$id_user','$id_produk','$NULL','$nama_desain','$newgambar_depan','$newgambar_belakang','$ukuran_s','$ukuran_m','$ukuran_l','$ukuran_xl','')";
	...
	if ($query) {
		...
		echo "<script type='text/javascript'>
    		...
    		document.location = '../masukkeranjang'; 
    	</script>";
	}
}
