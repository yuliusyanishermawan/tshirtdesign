            ...
            <form>
              <div class="card-body">
                ...
                <div class="card-footer">
                  <a href="dikerjakandata.php" type="button" class="btn btn-primary">Kembali</a>
                </div>
            </form>
          </div>
          <div class="card-body">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-info btn-sm" href="../imagedesainuser/<?php echo htmlentities($result['gambar_depan']); ?>" download="<?php echo $result['no_invoice'];
                                                                                                                                              echo "_";
                                                                                                                                              echo $result['nama_order'];
                                                                                                                                              echo "_gambardepan_", date('dmYHis'); ?>"><i class="fas fa-pencil-alt"></i>Gambar Depan</a><br><br>
                      <a class="btn btn-info btn-sm" href="../imagedesainuser/<?php echo htmlentities($result['gambar_belakang']); ?>" download="<?php echo $result['no_invoice'];
                                                                                                                                                  echo "_";
                                                                                                                                                  echo $result['nama_order'];
                                                                                                                                                  echo "_gambarbelakang", date('dmYHis'); ?>"><i class="fas fa-pencil-alt"></i>Gambar Belakang</a>
                    </td>
                  </tr>
                <?php } ?>
            </table>
