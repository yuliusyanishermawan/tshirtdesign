            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                  $nomor = 0;
                  $sql = "SELECT * FROM tbl_order INNER JOIN  tbl_user ON tbl_order.id_user=tbl_user.id_user WHERE tbl_order.status='Pesanan Selesai'";
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo htmlentities($result['resi_pengiriman']); ?></td>
                      <td><?php echo date('d F Y', strtotime($result['tanggal_order'])); ?></td>
                      <td class="text-center">
                        <a class="btn btn-info btn-sm" href="selesaiedit?id=<?php echo $result['no_invoice']; ?>"><i class="fas fa-pencil-alt"></i>Edit</a>
                      </td>
                    </tr>
                  <?php } ?>
              </table>
