      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="card card-primary">
            ...
            ?>
            <form method="POST" enctype="multipart/form-data" action="action/dikerjakaneditact">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="status">
                    ...
                    <?php
                    if ($result['provinsi'] == "Pickup") {
                      echo "<option value='Pesanan Selesai'>Pesanan Selesai</option>";
                    } else {
                      echo "<option value='Selesai Dikerjakan'>Selesai Dikerjakan</option>";
                    }
                    ?>
