      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="card card-primary">
            ...
            ?>
            <form method="POST" enctype="multipart/form-data" action="action/selesaidikerjakaneditact">
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="inputCity">Input Resi</label>
                  <input type="text" name="resi_pengiriman" class="form-control" placeholder="Masukkan nomer resi" required>
                </div>
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Input Resi</button>
                </div>
            </form>
          </div>
          <div class="card-body">
