      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="card card-primary">
            ...
            ?>
            <form method="POST" enctype="multipart/form-data" action="action/konfirmasieditact">
              <div class="card-body">
                ...
                <div class="form-group ">
                  ...
                  <select class="form-control" name="status">
                    ...
                    <option value="Menunggu Dikerjakan">Menunggu Dikerjakan</option>
                ...
                <div class="form-row">
                  <div class="form-group col-md-4">
                    ...
                    <a href="../bukti/<?php echo htmlentities($result['bukti']); ?>" target="_blank"><img style="border: none;" src="../bukti/<?php echo htmlentities($result['bukti']); ?>" width=" 300" height="200" style="border:solid 1px #000" alt="../bukti/<?php echo htmlentities($result['bukti']); ?>"></a>
                  </div>
                </div>
