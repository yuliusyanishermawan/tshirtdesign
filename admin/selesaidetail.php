            ...
            <form>
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="<?php echo htmlentities($result['resi_pengiriman']); ?>" name="resi_pengiriman" class="form-control" placeholder="Masukkan nomer resi" required readonly>
                </div>
                <div class="card-footer">
                  <a href="selesaidata.php" type="button" class="btn btn-primary">Kembali</a>
                </div>
            </form>
          </div>
          <div class="card-body">
